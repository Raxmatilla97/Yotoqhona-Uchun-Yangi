                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <div class="sm:flex sm:items-center sm:justify-between">
                                ...
                                <div class="flex items-center mt-4 gap-x-3">
                                    ...
                                    <button id="btn2" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="px-12 py-4 text-sm font-normal text-gray-700 whitespace-nowrap">
                                                                ...
                                                                @elseif($ariza->mezon == 'ijtimoiy_himoya')
                                                                    “Ijtimoiy himoya yagona reestri” axborot tizimi (my.gov.uz) orqali kam ta’minlangan deb e’tirof etilgan oila farzandlari (Bunda, 2023-yilda axborot tizimiga kiritilgan oilalar hisobga olinadi).

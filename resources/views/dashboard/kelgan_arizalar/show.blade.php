                ...
                <div class=" p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <section class="container px-4 mx-auto">
                        <div class="flex items-center gap-x-3">
                            ...
                            <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">12</span>
                        </div>                  
                            ...
                            <div class="sm:flex sm:items-center sm:justify-between">
                                ...
                                <div class="flex items-center gap-x-3">
                                    ...
                                    <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">324234234</span>
                                </div>
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                    ...
                                                    <tr class="bg-blue-50">
                                                        ...
                                                        <td class="border-t border-r border-blue-500 px-12 py-4 text-sm font-normal text-gray-700 whitespace-nowrap">
                                                            ...
                                                            <select id="large" class="block w-full px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                ...
                                                                <option value="">Ko'rib chiqilmoqda</option>
                                                                <option value="maqullandi">Maqullandi!</option>
                                                    ...
                                                    <tr class="bg-blue-50">
                                                        ...
                                                        <td class="border-r border-b border-t border-blue-500 px-12 py-4 text-sm font-normal text-gray-700 whitespace-nowrap">
                                                            ...
                                                            <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Assalomu alaykum, hurmatli....."></textarea>
                                                        </td>
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500 rounded-lg sm:w-auto gap-x-2 hover:bg-green-600 dark:hover:bg-green-500 dark:bg-green-600">
                                                      
                                    <span>Anketaga javobni sqalash</span>
                                </button>
                            </div>
                        </section>

                ...
                <div class=" p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <section class="container px-4 mx-auto">
                        <div class="flex items-center gap-x-3">
                            ...
                            <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">100 ta</span>
                        </div>
                                                ...
                                                <tr>
                                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                        <div class="inline-flex items-center gap-x-3">
                                                            ...
                                                            <div class="flex items-center gap-x-2">
                                                                ...
                                                                <div>
                                                                    <h2 class="font-medium text-gray-800 dark:text-white ">Fayziyev Raxmatilla Xanshor og'li</h2>
                                                    ...
                                                    <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                        <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                                            ...
                                                            <h2 class="text-sm font-normal text-emerald-500">Maqullangan</h2>
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">AA3014323</td>
